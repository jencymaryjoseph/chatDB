...
# Test Queries
# sql_queries = [
#     "SELECT year, AVG(mileage) AS average_mileage FROM vehicles GROUP BY year HAVING AVG(mileage) > 1000",
#     "SELECT year, AVG(condition) AS average_condition FROM vehicles GROUP BY year HAVING AVG(condition) > 4",
#     "SELECT year, AVG(mileage) AS average_mileage FROM vehicles GROUP BY year HAVING AVG(mileage) = 1000",
#     "SELECT condition, AVG(price) AS average_price FROM vehicles GROUP BY condition HAVING AVG(price) > 5000",
#     "SELECT condition, AVG(price) AS average_price FROM vehicles GROUP BY condition HAVING AVG(price) < 5000",
#     "SELECT year, SUM(mileage) AS total_mileage FROM vehicles GROUP BY year",
#     "SELECT make, SUM(price) AS total_price FROM vehicles GROUP BY make",
#     "SELECT condition, AVG(price) AS average_price FROM vehicles GROUP BY condition",
#     "SELECT year, condition, COUNT(*) AS total_cars FROM vehicles GROUP BY year, condition",
#     "SELECT price FROM vehicles ORDER BY price DESC",
#     "SELECT * FROM vehicles WHERE year = '2020' AND make = 'Toyota' ORDER BY price DESC",
#     "SELECT price FROM vehicles ORDER BY price ASC",
#     "SELECT * FROM vehicles WHERE make = 'Honda' ORDER BY model DESC",
#     "SELECT model FROM vehicles WHERE make = 'Toyota'",
#     "SELECT mileage FROM vehicles WHERE year = '2022'",
#     "SELECT COUNT(*) FROM vehicles WHERE make = 'Toyota'",
#     "SELECT year, condition, mileage, model FROM vehicles WHERE year = '2020' AND make = 'Toyota'",
#     "SELECT condition FROM vehicles WHERE year = '2022'",
#     "SELECT condition FROM vehicles WHERE year = '2019' AND make = 'Toyota'",
#     "SELECT SUM(mileage) AS total_mileage FROM vehicles WHERE make = 'Toyota'",
#     "SELECT AVG(condition) AS average_condition FROM vehicles WHERE year = '2020' AND make = 'Honda'",
#     "SELECT COUNT(*) FROM vehicles WHERE year = '2021'",
#     "SELECT MAX(price) AS max_price FROM vehicles WHERE make = 'Toyota'",
#     "SELECT AVG(price) AS average_price FROM vehicles WHERE year = '2021'",
#     "SELECT SUM(price) AS total_price FROM vehicles WHERE year = '2020'",
#     "SELECT price, model FROM vehicles WHERE make = 'Ford'",
#     "SELECT MAX(year) AS max_year FROM vehicles",
#     "SELECT year, mileage FROM vehicles WHERE year = '2020' AND make = 'Toyota'",
#     "SELECT model FROM vehicles WHERE make = 'Toyota'",
#     "SELECT * FROM vehicles WHERE year = '2020'",
#     "SELECT * FROM vehicles WHERE year = '2019' AND make = 'Toyota'",
#     "SELECT manufacturer, model FROM vehicles WHERE year = '2021'",
#     "SELECT model FROM vehicles WHERE year = '2019' AND make = 'Toyota'",
#     "SELECT MAX(price) AS max_price FROM vehicles WHERE model = 'Sorento' AND make = 'Kia'"
# ]

# Convert and display MongoDB queries
# for sql in sql_queries:
#     print(f"SQL Query: {sql}")
#     try:
#         mongodb_query = sql_to_mongodb(sql)
